...
;; Author: Emil Åström <emil.astrom@excosoft.se>
;;         Milan Zamazal <pdm@freesoft.cz>
;;         (see below for more details)
;; Maintainer: Stefan Bruda <bruda@ubishops.ca>
...
;;
;; The code requires the comint, easymenu, info, imenu (FSF Emacs
;; only), and font-lock libraries. These are normally distributed with
;; GNU Emacs and XEmacs.

;;; Installation:
;;
;; Insert the following lines in your ~/.emacs (FSF Emacs and XEmacs
;; <21.4), or ~/.xemacs/init.el (XEmacs 21.4) to use this mode when
;; editing Prolog files under Emacs:
;;
...
;; setting. If this is not wanted, remove this line. It is then
;; necessary to either
;;
...
;;     M-x prolog-mode.
;;
;; If the command to start the prolog process ('sicstus', or 'pl' for
;; SWI prolog) is not available in the default path, then it is
...
;;   developments will thus biased towards XEmacs (OK, I admit it, I
;;   am biased towards XEmacs in general), though I will do my best
;;   to keep the FSF Emacs compatibility.  So if you work under Emacs
;;   and see something that does not work, do drop me a line, as I
;;   have little chance to notice this kind of bugs otherwise.
...
(defcustom prolog-imenu-flag nil
